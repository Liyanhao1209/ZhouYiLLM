                ...
                <div class="card-content">
                    <div class="card-header">
                        <div class="left-items">
                            ...
                            <span class="text item" style="text-align: left;font-size: 18px;">{{ chat.conv_name
                                }}</span>
                        </div>
                        ...
                        <div class="right-items">
                            ...
                            <el-button class="text item" type="text" @click="setCurrentChat(chat)"
                                style="text-align: right;">
                                对话详情
                            </el-button>
                            <el-icon class="text item" style="left: 0%;font-size: 24px;"
                                @click="deleteCurrentChat(chat)">
                                <Delete />
                            </el-icon>
                        </div>
                    </div>
